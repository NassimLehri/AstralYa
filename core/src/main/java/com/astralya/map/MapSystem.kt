...
object MapRegistry {
    ...
    val VILLAGE_DEPART = GameMap(
        ...
        chests = listOf(
            ...
            Chest("chest_village_2", Position(700f, 100f), "potion_mp", 2)
        ),
        portals = listOf(
            Portal("portal_village_foret", Position(750f, 300f), "foret_enchantee", 48f, 300f)
        ),
        questTriggers = listOf(
            QuestTrigger("quete_principale_1", Position(320f, 288f), 80f, "TALK")
        )
    )
    ...
    val FORET_ENCHANTEE = GameMap(
        ...
        portals = listOf(
            Portal("portal_foret_village", Position(48f, 300f), "village_depart", 720f, 300f),
            Portal("portal_foret_grotte", Position(900f, 400f), "grotte_cristal", 48f, 200f)
        )
    )
    ...
    val GROTTE_CRISTAL = GameMap(
        ...
        portals = listOf(
            Portal("portal_grotte_foret", Position(48f, 200f), "foret_enchantee", 880f, 400f),
            Portal("portal_grotte_desert", Position(620f, 620f), "desert_oublie", 100f, 300f)
        ),
        questTriggers = listOf(
    ...
    val DESERT_OUBLIE = GameMap(
        ...
        portals = listOf(
            Portal("portal_desert_grotte", Position(100f, 300f), "grotte_cristal", 580f, 600f),
            Portal("portal_desert_temple", Position(1000f, 500f), "temple_etoiles", 64f, 400f)
        )
    )
    ...
    val TEMPLE_ETOILES = GameMap(
        ...
        portals = listOf(
            Portal("portal_temple_desert", Position(64f, 400f), "desert_oublie", 980f, 500f),
            Portal("portal_temple_cite", Position(700f, 680f), "cite_volante", 100f, 300f)
        )
    )
    ...
    val CITE_VOLANTE = GameMap(
        ...
        portals = listOf(
            Portal("portal_cite_temple", Position(100f, 300f), "temple_etoiles", 680f, 680f),
            Portal("portal_cite_chateau", Position(830f, 350f), "chateau_morvax", 64f, 400f)
        )
    )
    ...
    val CHATEAU_MORVAX = GameMap(
        ...
        portals = listOf(
            Portal("portal_chateau_cite", Position(64f, 400f), "cite_volante", 810f, 350f)
        ),
        questTriggers = listOf(
